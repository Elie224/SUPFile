...
const translations = {
  fr: {
    ...
    trashEmptiedPartial: '{{success}} supprimé(s), {{failed}} n\'ont pas pu être supprimé(s).',
    ...
    deletePermanentSuccess: 'Élément(s) supprimé(s) définitivement',
    deletePermanentError: 'Erreur lors de la suppression définitive',
    deletePermanentPartial: '{{success}} supprimé(s), {{failed}} n\'ont pas pu être supprimé(s).',
    confirmDeletePermanent: 'Supprimer définitivement',
    ...
    downloadTimeout: 'Le téléchargement a pris trop de temps. Réessayez ou choisissez un dossier plus petit.',
    folderEmptyServer: 'Ce dossier ne contient aucun fichier accessible sur le serveur.',
  ...
  en: {
    ...
    trashEmptiedPartial: '{{success}} deleted, {{failed}} could not be deleted.',
    confirmEmptyTrash: 'Are you sure you want to empty the trash? This action is irreversible.',
    deletePermanent: 'Delete permanently',
    deletePermanentSuccess: 'Item(s) permanently deleted',
    deletePermanentError: 'Error during permanent deletion',
    deletePermanentPartial: '{{success}} deleted, {{failed}} could not be deleted.',
    ...
    downloadStarting: 'Download in progress...',
    downloadSuccess: 'Download successful',
    downloading: 'Downloading...',
    downloadTimeout: 'Download took too long. Try again or choose a smaller folder.',
    folderEmptyServer: 'This folder has no files accessible on the server.',
