# Script pour configurer les secrets sur 'backend-sparkling-sun-1539' depuis le fichier .env local

Write-Host ""
Write-Host "CONFIGURATION DES SECRETS POUR LA NOUVELLE APPLICATION" -ForegroundColor Cyan
...
# SESSION_SECRET : utiliser JWT_SECRET si pas defini
