...
MONGO_URI=mongodb://supfile_root:votre_mot_de_passe_mongo_secure@db:27017/supfile?authSource=admin

# JWT (générer des secrets forts, au moins 32 caractères)
JWT_SECRET=votre_secret_jwt_min_32_caracteres
JWT_REFRESH_SECRET=votre_secret_refresh_jwt_min_32_caracteres
```
...
- **MongoDB Atlas** : pour la base de données, utiliser une URI du type `mongodb+srv://...` dans `MONGO_URI`.
