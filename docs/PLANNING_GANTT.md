...
```mermaid
gantt
    title SUPFile - Planning (10 Dec 2025 to 06 Apr 2026)
    ...
    Backend - auth base (signup/login/refresh) [Nema Elisee + Mohamed] :s1b, 2025-12-10, 14d
    ...
    Backend - folders CRUD + listing [Nema Elisee + Mohamed] :s2b, 2025-12-24, 14d
    ...
    Backend - upload-download + stockage uploads [Nema Elisee + Mohamed] :s3b, 2026-01-07, 14d
    ...
    Backend - preview-stream (image pdf video) [Nema Elisee + Mohamed] :s4b, 2026-01-21, 14d
    ...
    Backend - partage public-interne + tokens [Nema Elisee + Mohamed] :s5b, 2026-02-04, 14d
    ...
    Backend - 2FA + reset password [Nema Elisee + Mohamed] :s6b, 2026-02-18, 14d
    ...
    Backend - dashboard + search + corbeille [Nema Elisee + Mohamed] :s7b, 2026-03-04, 14d
